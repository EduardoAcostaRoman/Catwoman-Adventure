...
public class CameraLevel2MiniBoss : MonoBehaviour {
    ...
    private float camY;
    private float angle;
    private float minX = -3.35f, minY = 0f, maxX = 3.35f, maxY = 1.36f;
    ...
    void Start()
    {
        ...
        this.GetComponent<Animator>().SetBool("miniBoss2", true);
    }
    ...
    void Update () {
        ...
        if (this.GetComponent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("level2MiniBoss"))
        {
            ...
            this.GetComponent<Animator>().SetBool("miniBoss2", false);
