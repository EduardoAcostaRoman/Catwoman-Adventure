...
public class Harpy : MonoBehaviour {
    ...
    void Update()
    {
        if (this.gameObject.transform.GetChild(1).gameObject.GetComponent<SpriteRenderer>().sprite.name == "blank")
        {
        ...
        else
        {
            ...
            if (animator.GetCurrentAnimatorStateInfo(0).IsName("hurt"))
            {
                ...
                this.gameObject.transform.GetChild(0).gameObject.layer = 0;
            }
            ...
            if (death >= 2 && sprite.sprite.name == "harpy_24")
            {
                ...
                this.gameObject.transform.GetChild(1).gameObject.GetComponent<Animator>().SetBool("boom", true);
                body.velocity = new Vector2(0, 0);
            }
            if (this.gameObject.transform.GetChild(1).gameObject.GetComponent<SpriteRenderer>().sprite.name == "blank")
            {
