...
public class CameraLevel2FinalBoss : MonoBehaviour
{
    ...
    private float camY;
    private float angle;
    private float minX = -6.07f, minY = -5.32f, maxX = 11.15f, maxY = -2.78f;
    ...
    void Start()
    {
        ...
        //GetComponent<Animator>().SetBool("finalBoss", true);
    }
